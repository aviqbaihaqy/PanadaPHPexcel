...
<head>
    ...
    <link href="<?php echo $this->uri->baseUri;?>assets/default/css/bootstrap.min.css" rel="stylesheet">
    <link href="<?php echo $this->uri->baseUri;?>assets/default/font-awesome/css/font-awesome.css" rel="stylesheet">
	...
	<script type="text/javascript" language="javascript" src="<?php echo $this->uri->baseUri;?>assets/default/js/jquery-1.8.2.min.js"></script>
</head>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index">Admin V. 0.2</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="<?php echo $this->uri->baseUri; ?>"><i class="fa fa-dashboard fa-fw"></i>Import</a>
                    </li>
                </ul>
                <!-- /#side-menu -->
            </div>
		...
		<!-- /#page-wrapper -->
		<?php if(isset($halaman)) $this->output('default/'.$halaman);?>
        <!-- /#page-wrapper -->

    </div>
    <!-- /#wrapper -->

    <script src="<?php echo $this->uri->baseUri;?>assets/default/js/bootstrap.min.js"></script>
    ...
    <script src="<?php echo $this->uri->baseUri;?>assets/default/js/plugins/dataTables/dataTables.bootstrap.js"></script>
    ...
    <script src="<?php echo $this->uri->baseUri;?>assets/default/js/demo/dashboard-demo.js"></script>
