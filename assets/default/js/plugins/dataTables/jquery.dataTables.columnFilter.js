...
(function ($) {
    ...
    $.fn.columnFilter = function (options) {
        ...
        function fnCreateInput(oTable, regex, smart, bIsNumber, iFilterLength, iMaxLenght) {
            ...
            var search_init = 'search_init form-control input-sm ';
            var inputvalue = label;
			var sWidth = parseInt(oTable.fnSettings().aoColumns[i].sWidth); // tambahan dari aviq
            ...
            var input = $('<input type="text" style="width:'+(sWidth-15)+'px" class="' + search_init + sCSSClass + '" placeholder="' + inputvalue + '"/ >');
